...
_Note: The following commands use bun, but you can use other package managers._
...
- Make sure to preview the prod build locally with `bun run build && bun preview`.
