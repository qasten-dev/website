  ...
  en: {
    ...
    homePage: {
      ...
      stories: {
        ...
        subtitle: "Our clients automate thousands of hours of manual work, cut costs, and unlock new revenue—all within the first 60 days.",
      ...
      solutions: {
        ...
        voice: { title: "Voice Agents", description: "Answer inbound calls, qualify leads in real-time, and book meetings directly into your calendar—24/7." },
      ...
      benefits: {
        title: "Why Teams Choose Qasten",
        subtitle: "No templates. No shortcuts. Just custom AI systems that deliver measurable results.",
        custom: { title: "Built for Your Business", description: "No templates. Every agent is engineered around your workflows, data, and goals." },
        ownership: { title: "You Own Everything", description: "Full ownership of your agents, data, and infrastructure. No vendor lock-in, no recurring platform fees." },
        integrated: { title: "Deep Integrations", description: "Native connections to Salesforce, HubSpot, your inbox, and 50+ tools your team already uses." },
        results: { title: "Measurable ROI", description: "Track performance in real-time. Our clients see 3.5x ROI within the first 60 days." },
      },
      integrations: {
      ...
      whyChoose: {
        title: "Why Leading Teams Choose Qasten",
        subtitle: "Built by engineers with enterprise experience—not prompt engineers with templates.",
        qasten: ["Full ownership of agents, data, and infrastructure", "AI engineers with enterprise experience (ex-AWS, Datadog, OpenAI)", "Systems designed for revenue growth, not just automation", "100% custom development—no templates or low-code shortcuts", "Native integrations with your CRM and communication stack", "End-to-end delivery: strategy to scale"],
        othersTitle: "Other Development Agencies",
        others: ["Limited ownership, ongoing platform fees", "One-size-fits-all solutions", "Template-based with minimal customization"],
      },
      booking: {
        title: "See How AI Can Transform Your Operations",
        subtitle: "Book a free 30-minute call. We'll analyze your workflows and show you exactly how AI can save 60+ hours/month and drive new revenue.",
        fullName: "Full Name",
        email: "Email",
        company: "Company",
      ...
      faq: {
        ...
        questions: [
          ...
          { question: "How much time or money can this realistically save me?", answer: "Our clients typically save 60+ hours per month and see $1.2M+ in annual cost savings. The average ROI in the first 60 days is 3.5x, making it a highly cost-effective investment." },
          ...
          { question: "What industries does this work for?", answer: "Our custom AI infrastructure works across multiple industries—sales, operations, customer service, finance, and more. If you have repeatable workflows, we can automate them." },
          { question: "Do I need to be \"tech-savvy\" to use this?", answer: "No. Our systems integrate seamlessly with your existing workflows. Once deployed, they run automatically in the background—no technical expertise required." },
          ...
          { question: "Is my data safe?", answer: "Yes. You own the agents, data, and infrastructure. We follow strict security protocols, host in the EU, and ensure your data remains secure and private." },
          { question: "How do I get started?", answer: "Book a free 30-minute strategy call. We'll analyze your workflows and show you exactly how AI can save 60+ hours/month and drive new revenue—with real examples from similar businesses." },
        ],
      },
    },
  },
  ...
  fr: {
    ...
    homePage: {
      ...
      stories: {
        ...
        subtitle: "Nos clients automatisent des milliers d'heures de travail manuel, réduisent leurs coûts et débloquent de nouveaux revenus—le tout dans les 60 premiers jours.",
      ...
      solutions: {
        ...
        voice: { title: "Agents Vocaux", description: "Répondez aux appels entrants, qualifiez les leads en temps réel et planifiez des rendez-vous directement dans votre agenda—24h/24." },
        ...
        footer: "Plus de 600 entreprises accompagnées, plus de 10 000 personnes formées",
      },
      benefits: {
        title: "Pourquoi les Équipes Choisissent Qasten",
        subtitle: "Pas de templates. Pas de raccourcis. Juste des systèmes IA sur-mesure qui délivrent des résultats mesurables.",
        custom: { title: "Conçu pour votre entreprise", description: "Pas de templates. Chaque agent est conçu autour de vos workflows, données et objectifs." },
        ownership: { title: "Propriété totale", description: "Vous êtes propriétaire de vos agents, données et infrastructure. Pas de dépendance fournisseur, pas de frais de plateforme." },
        integrated: { title: "Intégrations natives", description: "Connexions natives avec Salesforce, HubSpot, votre messagerie et plus de 50 outils que votre équipe utilise déjà." },
        results: { title: "ROI mesurable", description: "Suivez les performances en temps réel. Nos clients obtiennent un ROI de 3,5x dans les 60 premiers jours." },
      },
      integrations: {
      ...
      whyChoose: {
        title: "Pourquoi les Meilleures Équipes Choisissent Qasten",
        subtitle: "Construit par des ingénieurs avec une expérience enterprise—pas des prompt engineers avec des templates.",
        qasten: ["Propriété totale des agents, données et infrastructure", "Ingénieurs IA avec expérience enterprise (ex-AWS, Datadog, OpenAI)", "Systèmes conçus pour la croissance du CA, pas juste l'automatisation", "Développement 100% sur-mesure—pas de templates ni de low-code", "Intégrations natives avec votre CRM et stack de communication", "Livraison de bout en bout : de la stratégie au passage à l'échelle"],
        othersTitle: "Autres agences de développement",
        others: ["Propriété limitée, frais de plateforme récurrents", "Solutions prêtes à l'emploi", "Basé sur des templates avec peu de personnalisation"],
      },
      booking: {
        title: "Découvrez Comment l'IA Peut Transformer Vos Opérations",
        subtitle: "Réservez un appel gratuit de 30 minutes. Nous analyserons vos workflows et vous montrerons exactement comment l'IA peut économiser plus de 60h/mois et générer de nouveaux revenus.",
      ...
      faq: {
        ...
        questions: [
          ...
          { question: "Combien de temps ou d'argent cela peut-il réellement me faire économiser ?", answer: "Nos clients économisent généralement plus de 60 heures par mois et réalisent plus de 1,2M€ d'économies annuelles. Le ROI moyen dans les 60 premiers jours est de 3,5x, ce qui en fait un investissement très rentable." },
          ...
          { question: "Dois-je être « technophile » pour utiliser cela ?", answer: "Non. Nos systèmes s'intègrent parfaitement à vos workflows existants. Une fois déployés, ils fonctionnent automatiquement en arrière-plan—aucune expertise technique requise." },
          ...
          { question: "Mes données sont-elles en sécurité ?", answer: "Oui. Vous êtes propriétaire des agents, données et infrastructure. Nous suivons des protocoles de sécurité stricts, hébergeons dans l'UE et garantissons que vos données restent sécurisées et privées." },
          { question: "Comment puis-je commencer ?", answer: "Réservez un appel stratégique gratuit de 30 minutes. Nous analyserons vos workflows et vous montrerons exactement comment l'IA peut économiser plus de 60h/mois et générer de nouveaux revenus—avec des exemples concrets d'entreprises similaires." },
        ],
      },
    },
  },
